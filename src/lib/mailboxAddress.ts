import type { MailboxAddress } from './api-types'
...
export function sortMailboxesNewestFirst(mailboxes: MailboxAddress[]): MailboxAddress[] {
  return [...mailboxes].sort((left, right) => right.createdAt - left.createdAt)
}
